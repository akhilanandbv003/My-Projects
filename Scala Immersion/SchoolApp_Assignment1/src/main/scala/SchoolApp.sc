/**
  * Created by PC-User on 6/19/2017.
  */
import scala.collection.mutable
import scala.collection.mutable._
import scala.io.StdIn._

object SchoolEvents extends App {
  println("Hello World!!")
  ...
  object eventsHandler {
    ...
    def enrollmentActivity( event :enrollmentEvent): Unit={
      event match{
        case addClass(className: String)  => //Check if the event triggered is of addClass
  ...
  while (input != 0) {
    ...
    input match {
      ...
      case 3 =>{
        ...
        eventsHandler.enrollmentActivity(new enrollClass(studentName, className))
      }
      ...
      case 4 =>{
        ...
        val className = readLine()
        eventsHandler.enrollmentActivity(new cancelEnrollment(studentName, className))
      }
      case 5 => {
        println("Enter class name to be cancelled")
        val className = readLine()
        eventsHandler.enrollmentActivity(new removeClass(className))
      }
      ...
      case 6 => {
        ...
        val studentName = readLine()
        println("Students")
        eventsHandler.studentActivity(new addStudent(studentName))
        println(students)
      ...
      case 7 =>{
        ...
        val className = readLine()
        eventsHandler.enrollmentActivity(new addClass(className))
        println(courses)
      }
    }
